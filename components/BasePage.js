  ...
  return (
     <>
       <Head >
         ...
         <meta property={'og:image'} key={'og:image'} content={`${process.env.BASE_URL}/images/section-2.png`}/>
         <link rel='icon' type={'image/x-icon'} href={"/favicon.ico"}/>
         <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;700&display=swap" rel="stylesheet"/>
         <link rel={'cononical'} href={`${process.env.BASE_URL}${canonicalPath ? canonicalPath:router.asPath}`}/>
